...
def balanced(m):
    ...
    if is_planet(m):
        ...
        return (t1 == t2) and balanced(end(left(m))) and balanced(end(right(m)))
...
def quadratic(x, a, b, c):
    ...
    extreme_point = a*extreme_point_x*extreme_point_x + b*extreme_point_x +c
    if lower_bound(x) <= extreme_point_x and extreme_point_x <= upper_bound(x):
        return interval(min(lower, upper, extreme_point), max(lower, upper, extreme_point))
    else:
